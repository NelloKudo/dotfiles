...
BORDER_WIDTH="1"	NORMAL_BC="#0d0c0c"		FOCUSED_BC="#938AA9"

# Fade true|false	# Shadows true|false	# Corner radius		# Shadow color			# Animations true|false
P_FADE="true"		P_SHADOWS="true"		P_CORNER_R="6"		SHADOW_C="#000000"		ANIMATIONS="false"
...
# Gtk theme vars
gtk_theme="Nord-zk"	gtk_icons="Colloid-Nord-Dark"	gtk_cursor="Qogirr-Dark"	geany_theme="z0mbi3-KanagawaDragon"
